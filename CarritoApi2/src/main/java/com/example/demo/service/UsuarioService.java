...
//	public void addPedido(String idUsuario, Pedido nuevoPedido) {
...
//	}
	...
	public Usuario edit(Usuario usuario) {
		...
		Usuario nuevoUsuario = findById(usuario.getNickName());
		
		nuevoUsuario.setListaPedidos(usuario.getListaPedidos());
