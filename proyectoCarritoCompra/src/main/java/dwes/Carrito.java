...
public class Carrito extends HttpServlet {
	 ...
	 */
	HashSet<Producto>productosEnCarrito= new HashSet<Producto>();
...
//					if(productoCarrito.getId().equals(productoId)) {
				/*
...
//				}
			...
			//Si no pulsamos el boton de borrar, será porque el boton pulsada ha sido el de añadir al carrito
			else {
